...
public class LinkedContainer<E> implements Linked<E>, Iterable<E> {
    public static void main(String[] args) {
        ...
        stringLinked.addLast("zzz");

        System.out.println("Size :" + stringLinked.size());
        System.out.println("First element :" + stringLinked.getElementByIndex(0));
        System.out.println("Last element :" + stringLinked.getElementByIndex(1));
    }
